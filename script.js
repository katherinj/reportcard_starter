...
const studentInformation = {
  name: "Katherin Jimenez",
  grade: "12",
  advisor: "Doug",
  major: "Computer Science",
  graduationYear: "2024",
  imageUrl: "https://tenor.com/view/tkthao219-bunny-gif-22166868",
}
...
const studentAdvisorTxt = document.querySelector("#student-advisor")
const studentMajorTxt = document.querySelector("#student-major")
const studentGradeLevelTxt = document.querySelector("#student-grade-level")
const studentGraduationYearTxt = document.querySelector("#student-graduation-year")
const studentImage = document.querySelector("#student-image")

const dropdownElement = document.querySelector(".dropdown")
const dropdownButtonIconElement = document.querySelector(".dropdown-icon")
...
const semesterDropdownTxt = document.querySelector(".dropdown-label")
...
function updateStudentGradeLevel(studentGradeLevel) {
  studentGradeLevelTxt.innerHTML = studentGradeLevel;
}
...
function updateStudentAdvisor(studentAdvisor) {
  studentAdvisorTxt.innerHTML = studentAdvisor;
}
...
function updateMajor(studentMajor) {
  studentMajorTxt.innerHTML = studentMajor
}
...
function updateStudentGraduationYear(graduationYear) {
  studentGraduationYearTxt.innerHTML = graduationYear;
}
...
function updateDropdownLabel() {
  semesterDropdownTxt.innerHTML = semester;
}
